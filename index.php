...
{
    $mail->setFrom("Contact@casicam.ma", 'Support CASICAM\'27');
...
if (isset($_POST["register"])) {
    ...
    try {
        ...
        $body = "
            <h2>New CASICAM'27 Registration</h2>
            ...
            <p><strong>CASICAM'27 Status:</strong> $casicam_status</p>
        ...
        if (sendEmail($mail, "zakaria.karkouri@outlook.com", "Registration", $body, "$first_name $last_name")) {
            renderStatusPage(
                ...
                "Thank you, {$first_name}! Your registration for CASICAM'27 has been submitted successfully. You will receive a confirmation email once your payment is processed.",
                true
            );
        } else {
            renderStatusPage(
...
<html lang="fr">
    ...
    <body id="top" class="text-white min-h-screen font-saira" data-theme="dark">
        <!-- Floating Video -->
            ...
            <div class="relative">
                ...
                <button id="expand-floating-video-modal" class="z-50 absolute -top-3 -left-3 w-8 h-8 rounded-full bg-[#222] border border-white/10 shadow-md flex items-center justify-center" title="Open Video">
                    <!-- Expand SVG: simple arrows out, fully visible -->
            ...
            <div id="floating-video-modal" class="hidden fixed inset-0 z-40 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
            <div class="relative bg-gray-900 rounded-2xl shadow-2xl p-4 max-w-screen-md xl:max-w-screen-xl max-h-screen">
                <button id="close-floating-video-modal" class="z-50 absolute top-3 right-3 w-8 h-8 rounded-full bg-[#222] border border-white/10 shadow-md flex items-center justify-center" title="Close">
                    <svg width="18" height="18" fill="none" stroke="white" stroke-width="2" viewBox="0 0 24 24"><line x1="6" y1="6" x2="18" y2="18"/><line x1="6" y1="18" x2="18" y2="6"/></svg>
                </button>
                <button id="collapse-floating-video-modal" class="z-50 absolute top-3 left-3 w-8 h-8 rounded-full bg-[#222] border border-white/10 shadow-md flex items-center justify-center" title="Collapse Video">
                ...
                <!-- The video element will be moved here dynamically -->
            </div>
        </div>
                ...
                <div class="mt-4 flex h-16 items-center justify-between gap-4 rounded-2xl border border-white/10 bg-white/[0.04] px-4 sm:px-6 shadow-[0_20px_60px_rgba(9,9,11,0.55)] backdrop-blur-2xl lg:h-[4.5rem]">
                    <a href="" class="flex items-center gap-3 text-white">
                        ...
                        <div class="hidden sm:flex flex-col leading-tight">
                            ...
                            <span class="text-[11px] font-medium text-white/55">Additive Manufacturing Summit 2027</span>
                        </div>
                    </a>
        ...
        <main class="pt-20 lg:pt-20">
                    ...
                    <div class="flex flex-col lg:flex-row items-stretch justify-center gap-6 min-h-[500px] mb-12">
                        ...
                        <div class="flex-1 lg:flex-[3] relative overflow-hidden rounded-2xl md:rounded-3xl glass card-hover shadow-2xl cursor-pointer focus:outline-none focus:ring-2 focus:ring-white/40" role="button" tabindex="0" aria-haspopup="dialog" aria-controls="intro-modal" data-intro-trigger style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);">
                            ...
                            <div class="relative z-10 p-6 sm:p-8 md:px-10 lg:px-14 h-full flex flex-col justify-center min-h-[400px] md:min-h-[500px]">
                                ...
                                <h1 class="leading-tight max-w-full">
                                    ...
                                    <span id="hero-year" class="typing-target block text-5xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-[6.5rem] font-semibold mt-2 sm:mt-4" data-typing-text="2027" aria-label="2027" style="letter-spacing: 0.05em; min-height: 1em;">2027</span>
                                </h1>
                        ...
                        <div class="flex-1 rounded-2xl md:rounded-3xl p-5 sm:p-6 card-hover shadow-xl cursor-pointer focus:outline-none focus:ring-2 focus:ring-white/40 relative overflow-hidden min-h-[300px] sm:min-h-[350px]" role="button" tabindex="0" aria-haspopup="dialog" aria-controls="placeholder-modal" data-placeholder-trigger style="background-image: url('assets/images/card2.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.4);">
                            ...
                            <div class="relative z-10 h-full flex flex-col">
                                <div class="mb-4">
                                    <h3 class="text-base sm:text-lg md:text-base lg:text-lg font-semibold mb-2 sm:mb-3 text-white flex flex-wrap items-center gap-2">Discover <span class="inline-block text-xs font-normal bg-white/10 px-2 py-1 rounded-full tracking-wide whitespace-nowrap">CASICAM'27</span></h3>
            ...
            <p class="text-white/60 text-xs">Explore the key sites connected to CASICAM 2027 below.</p>
            </div>
            </div>
            </div>
            <!-- Maps grid -->
            ...
            <h3 id="fees-heading" class="text-lg font-semibold mb-6">CASICAM 2027 Fee Matrix</h3>
            ...
            <li>For inclusion in the Conference Proceedings, authors must register no later than <span class="font-medium text-white">26 March 2027</span>.</li>
            <li>Deadline for registration for inclusion of the presentations in the Programme: <span class="font-medium text-white">09 April 2027</span>.</li>
            ...
            <?php if (function_exists('session_start')) { echo csrf_token_field(); } ?>
            ...
            <!-- CASICAM Status -->
            <div class="space-y-1.5">
            <label class="block text-xs uppercase tracking-wide text-white/60">CASICAM'27 Status *</label>
            ...
            <p class="text-white/55 mt-2 text-xs md:text-sm max-w-2xl">Full paper preparation, templates, submission channel & presentation requirements for CASICAM 2027.</p>
            </div>
            ...
            <p>All papers must conform to the official CASICAM 2027 template. Use the MS Word template available via the link below.</p>
            ...
            <p class="text-white/55 mt-2 text-xs md:text-sm max-w-2xl">Honorary, general, technical, organizing, PhD student and scientific committees contributing to CASICAM 2027.</p>
            </div>
            ...
            <div class="flex items-start md:items-center justify-between gap-6 px-6 md:px-10 pt-8 pb-6 border-b border-white/10">
            <div>
            <h2 id="intro-modal-title" class="text-2xl md:text-3xl font-semibold tracking-tight">Welcome to CASICAM'27</h2>
            ...
            Invitation to <span class="bg-gradient-to-r from-orange-400 via-red-400 to-pink-400 bg-clip-text text-transparent font-bold">CASICAM'27</span>
            </h3>
            ...
            <p>We are pleased to invite you to the <span class="bg-gradient-to-r from-orange-400 via-red-400 to-pink-400 bg-clip-text text-transparent font-bold">4th</span> edition of <strong>CASABLANCA INTERNATIONAL CONFERENCE ON ADDITIVE MANUFACTURING (CASICAM)</strong>, to be held in <span class="font-semibold text-white/90">Marrakech, Morocco</span>, on <strong class="bg-white/5 px-2 py-0.5 rounded-md text-white/95">April 23–25, 2027</strong>.</p>
            <p><strong>CASICAM'27</strong> is a scientific event organized by the Ecole Supérieure de Technologie de Casablanca (ESTC) and the Ecole Nationale Supérieure d'Electricité et de Mécanique (ENSEM) in collaboration with The Moroccan Association of Additive Manufacturing and 3D Printing (AMFAIM'3D).</p>
            ...
            <p class="text-white/80 font-medium">We look forward to seeing you at <strong>CASICAM'27</strong> in <strong>Marrakech, Morocco</strong>.</p>
            </div>
            </div>
            ...
            <p class="text-[14px] md:text-[15px] leading-relaxed">The official language of <strong>CASICAM'27</strong> is English . Simultaneous interpretation is not provided; presenters should be able to communicate fluently in English.</p>
            ...
            Marrakech, known as the "Red City," is a vibrant metropolis that perfectly blends ancient tradition with modern sophistication. As the host city for CASICAM'27, Marrakech offers an unforgettable backdrop for our international conference.
            </p>
            ...
            <span class="typing-target counter-value block text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-br from-white via-white to-white/80 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(255,255,255,0.15)]" data-counter data-typing-text="300+" data-typing-delay="0">300+</span>
            ...
            <span class="typing-target counter-value block text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-br from-white via-white to-white/80 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(255,255,255,0.15)]" data-counter data-typing-text="14" data-typing-delay="150">14</span>
            ...
            <span class="typing-target counter-value block text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-br from-white via-white to-white/80 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(255,255,255,0.15)]" data-counter data-typing-text="350+" data-typing-delay="300">350+</span>
            ...
            <span class="typing-target counter-value block text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-br from-white via-white to-white/80 bg-clip-text text-transparent drop-shadow-[0_2px_8px_rgba(255,255,255,0.15)]" data-counter data-typing-text="200" data-typing-delay="450">200</span>
        ...
        <footer class="bg-[#0a0a0a] border-t border-white/10" aria-labelledby="footer-heading">
            <div class="mx-auto px-4 sm:px-6 md:px-12 lg:px-40 py-4 sm:py-5 md:py-8">
                <h2 id="footer-heading" class="sr-only">CASICAM 2027 Footer</h2>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
                    ...
                    <div class="col-span-2 md:col-span-1 mb-2 md:mb-0">
                        <div class="text-xl sm:text-2xl font-bold tracking-wide select-none">
                            ...
                            <span class="text-gray-400 ml-1">2027</span>
    ...
    <script>
        ...
        // Floating video modal and box logic (use Tailwind classes instead of inline styles)
        const floatingBox = document.getElementById('floating-video-box');
        const floatingModal = document.getElementById('floating-video-modal');
        const openBtn = document.getElementById('expand-floating-video-modal');
        const collapseBtn = document.getElementById('collapse-floating-video-modal');
        const closeBoxBtn = document.getElementById('close-floating-video-box');
        const closeModalBtn = document.getElementById('close-floating-video-modal');


        // Move video to modal on expand
        openBtn.addEventListener('click', () => {
            const video = document.getElementById('floating-shared-video');
            const modalContent = floatingModal.querySelector('.relative');
        ...
        // Move video back to box on collapse
        collapseBtn.addEventListener('click', () => {
            const video = document.getElementById('floating-shared-video');
            const boxContent = floatingBox.querySelector('.relative');
            if (video && boxContent && !boxContent.contains(video)) {
                boxContent.appendChild(video);
                video.className = 'block w-80 sm:w-96 md:w-[28rem] max-w-screen-sm rounded-2xl shadow-2xl border border-white/10 bg-gray-900';
            }
            floatingModal.classList.add('hidden');
            floatingBox.classList.remove('opacity-0', 'pointer-events-none');
        });
