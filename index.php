...
<html lang="fr">
    ...
    <body id="top" class="bg-[#0a0a0a] text-white min-h-screen font-saira">
                            ...
                            <div class="px-6 md:px-10 pt-6">
                                <div class="relative rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] shadow-xl flex flex-col md:flex-row">
                                    <div class="md:w-1/4 relative">
                                        ...
                                        <img src="https://moroccodreamsafari.com/wp-content/uploads/2025/01/souk-of-Marrakech.webp" class="w-full h-60 md:h-full object-cover" loading="lazy" />
                                    </div>
                    ...
                    <div class="relative flex-1 overflow-hidden rounded-3xl border border-white/15 bg-[#101010]/95 shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_20px_60px_-10px_rgba(0,0,0,0.9)] backdrop-blur-xl">
                        ...
                        <div class="relative h-full flex flex-col">
                            ...
                            <div class="flex-1 overflow-auto px-6 md:px-10 pb-10 pt-6 space-y-12">
                                ...
                                <!-- Call To Action -->
                                <section class="space-y-6" aria-labelledby="cta-heading">
                                    <h3 id="cta-heading" class="text-lg font-semibold">Proceed with Registration</h3>
                    ...
                    <div class="relative flex-1 overflow-hidden rounded-3xl border border-white/15 bg-[#101010]/95 shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_20px_60px_-10px_rgba(0,0,0,0.9)] backdrop-blur-xl">
                        ...
                        <div class="relative h-full flex flex-col">
                            ...
                            <div class="flex-1 overflow-auto px-6 md:px-10 pb-10 pt-6">
                                ...
                                <button type="button" data-intro-close class="px-5 py-2.5 mt-8 rounded-full bg-white/15 hover:bg-white/25 text-xs md:text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-white/40">Close</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mx-auto px-6 md:px-12 lg:px-40 py-16">
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <article class="rounded-2xl overflow-hidden border border-white/10 bg-white/5 shadow-xl cursor-pointer group" data-gallery-item data-img-src="assets/images/pics/3.jpg" data-img-alt="Plenary session" data-img-caption="Plenary Session">
                            <div class="relative">
                                <img src="assets/images/pics/3.jpg" alt="Plenary session" class="w-full h-52 object-cover transition-transform duration-300 group-hover:scale-105" />
                            ...
                            <div class="p-4">
                                <h3 class="text-white font-medium">Plenary Session</h3>
                                <p class="mt-2 text-white/70 text-sm">A glimpse of the energy and discussion during the opening session.</p>
                            </div>
                        </article>
                        <!-- Image 2 -->
                        <article class="rounded-2xl overflow-hidden border border-white/10 bg-white/5 shadow-xl cursor-pointer group" data-gallery-item data-img-src="assets/images/pics/4.jpg" data-img-alt="Workshops and demonstrations" data-img-caption="Workshops & Demonstrations">
                            ...
                            <div class="p-4">
                                <h3 class="text-white font-medium">Workshops & Demonstrations</h3>
                                <p class="mt-2 text-white/70 text-sm">Captured moments from hands-on sessions where participants test new techniques.</p>
                            </div>
                        </article>
                        <!-- Image 3 -->
                        <article class="rounded-2xl overflow-hidden border border-white/10 bg-white/5 shadow-xl cursor-pointer group" data-gallery-item data-img-src="assets/images/pics/5.jpg" data-img-alt="Exhibition and innovations" data-img-caption="Exhibition & Innovations">
                            <div class="relative">
                                <img src="assets/images/pics/5.jpg" alt="Exhibition and innovations" class="w-full h-52 object-cover transition-transform duration-300 group-hover:scale-105" />
                                <div class="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent group-hover:bg-black/30 transition-colors duration-300"></div>
                                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div class="bg-white/20 backdrop-blur-sm rounded-full p-3">
                                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="p-4">
                                <h3 class="text-white font-medium">Exhibition & Innovations</h3>
                                <p class="mt-2 text-white/70 text-sm">Installations and prototypes that illustrate the future of additive manufacturing.</p>
                            </div>
                        </article>
                    </div>
                </div>
        ...
        <footer class="bg-[#0a0a0a] border-t border-white/10" aria-labelledby="footer-heading">
            <div class="mx-auto px-4 sm:px-6 md:px-12 lg:px-40 py-6 sm:py-8 md:py-12">
                <h2 id="footer-heading" class="sr-only">CASICAM 2026 Footer</h2>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
                    <!-- Brand -->
                    ...
                    <!-- Conference -->
                    <nav aria-label="Conference" class="space-y-2 sm:space-y-3">
                        <p class="text-white/90 font-medium text-sm sm:text-base">Conference</p>
                        <ul class="space-y-1.5 sm:space-y-2 text-white/70 text-xs sm:text-sm">
                    ...
                    <!-- Participation -->
                    <nav aria-label="Participation" class="space-y-2 sm:space-y-3">
                    ...
                    <!-- Social -->
                    <div class="col-span-2 md:col-span-1 space-y-2 sm:space-y-3">
                        <p class="text-white/90 font-medium text-sm sm:text-base">Social</p>
                        <ul class="flex md:flex-col gap-4 md:gap-3 text-white/70 text-xs sm:text-sm">
                            <li>
                ...
                <!-- Divider -->
                <div class="mt-6 sm:mt-8 md:mt-10 border-t border-white/10"></div>
                <!-- Bottom bar -->
                <div class="mt-4 sm:mt-5 md:mt-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-white/60 text-xs sm:text-sm">
                    <p>© 2026 CASICAM</p>
